...
**Progress: 0 / 9 phases complete** — flip each ⬜ to ✅ as a phase wraps.

| Status | Phase | What gets built | Core new skill | Duration @ 2h/day |
|---|---|---|---|---|
...
*(For linking to the actual write-ups — see the badges in the timeline table above for at-a-glance status. One entry per milestone: what was tried, what broke, what was learned.)*
...
- **Status badges in the timeline table** — flip ⬜ to ✅ next to a phase the moment it clears. It's the first thing visible when the repo opens, which is the point.
